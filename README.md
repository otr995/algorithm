...
| 날짜 | 유형 | 플랫폼 | 문제 | 난이도 | 비고 |
|---|---|---|---|---|---|
| 2026-04-29 | bfs-dfs | programmers | [수레 움직이기](https://school.programmers.co.kr/learn/courses/30/lessons/250134) / [수레 움직이기.md](%EC%88%98%EB%A0%88%20%EC%9B%80%EC%A7%81%EC%9D%B4%EA%B8%B0.md) | lv3 | bfs / dfs 기본 구조 구현에 대한 공부와 상태 및 경로에 관한 좋은 문제! |
